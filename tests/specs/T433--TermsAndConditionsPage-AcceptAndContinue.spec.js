...
describe('Initial app loading', () => {
  ...
  // Step 1. Click to 'Continue' -> 'Continue' is disabled
     ...
     expect(loginTermsPage.confirmAndContinueButton.getAttribute('disabled')).toBe('true')
     })
  ...
  //3. Check  any 3 checkboxes(for example - 1, 2, 4) and try to click -> 'Continue' is disabled
  it('', () => {
     // 1, 2, 3
     loginTermsPage.checkboxes[0].click()
     loginTermsPage.checkboxes[1].click()
  ...
  // 4. Check 1, 2, 3, 4, then uncheck one of then, than try to continue
  it('check marking of all checkboxes and unmarked one', () => {
     ...
     expect(loginTermsPage.confirmAndContinueButton.getAttribute('disabled')).toBe(null)

     // Uncheck 1st checkbox - button disabled
     loginTermsPage.checkboxes[0].click()
     expect(loginTermsPage.confirmAndContinueButton.getAttribute('disabled')).toBe('true')
     oginTermsPage.checkboxes[0].click()
