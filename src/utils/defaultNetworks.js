...
const defaultNetworks = [
  ...
  // { title: 'Main Ethereum Network', rpcaddr: '138.197.180.127', rpcport: '20001', ...defaultProps },
  // { title: 'Ropsten Test Network', rpcaddr: '37.59.55.6', rpcport: '20003', ...defaultProps },
