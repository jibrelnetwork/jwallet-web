 ...
 * TODO: Add crossTabStoreEvents test also
 * TODO: Add iOS test also
 */
...
Modernizr.addTest('crossTabStoreEvents', function() {
  // Safari does not support firing 'store' event on localStorage changes, so we detect it
